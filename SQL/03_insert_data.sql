...
(loan_name, description)
VALUES
(
    'Home Loan',
    'Long-term loan for residential property purchase or construction'
),
(
    'Personal Loan',
    'Unsecured loan for personal financial needs'
),
(
    'Vehicle Loan',
    'Loan for purchasing new or used automobiles'
),
(
    'Business Loan',
    'Commercial financing for business expansion and operational costs'
);
